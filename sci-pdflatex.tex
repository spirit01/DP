...
\begin{figure}
\caption{Struktura cyklu 4-členného kruhu z \cite{C4TA06823H};  Legenda: \mycircle{brown} Si, \mycircle{red}~O, \mycircle{orange}~C, \mycircle{yellow} P, \mycircleempty{black}~H, \mycircleempty{blue}~N .}
...
Z výsledků v tabulce \ref{hsab_small} lze vidět, že struktura \ce{Si(OCH3)4} má vyšší hodnotu $\eta$ než \ce{SiCH3(OCH3)3} a díky tomu je stabilnější. Oproti tomu stabilita dvojice \ce{Si(OCH3)6^{2-}} a \ce{SiCH3(OCH3)5^{2-}} klesla. Hodnota enrgie LUMO orbitaly pro tyto dva modely není úplně správná a to díky zápornému náboji, který zde nebyl nijak kompenzován.
...
HSAB analýza pro porovnání struktury \ce{Si(OCOCH3)4} \textbf{J} a jejími modifikacemi ukazuje, že náhradou acetátu za vodík ve struktuře \textbf{K} a následnou náhradou za methyl ve struktuře \textbf{L} vede k nárustu tvrdosti a tedy menšímu sklonu dále reagovat.  Výsledky jsou uvedeny v tabulce \ref{hsab_small_porovnani}.
...
\end{table}
Pro strukturu \ce{Si(OAC)4}, \textbf{J} jsou na obrázku \ref{prehled_nbo_SI_AC} uvedeny obrázky orbitalů č. 70, 71, 72 a 73 s jejich obsazovacími čísly.
