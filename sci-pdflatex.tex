...
\begin{table}[htbp]
  \begin{minipage}{\textwidth}
\caption{MPA analýza LUMO orbitalu pro \ce{Si(OCH3)6}, \textbf{D}, výsledky jsou uvedeny v [\%].}
\begin{center}
\begin{tabular}{|l|c|c|}
\hline
...
\begin{table}[htbp] \begin{minipage}{\textwidth}
\caption{MPA analýza \ce{Si(OCH3)4}, \textbf{B}, výsledky jsou uvedeny v [\%].}
\begin{center}
\begin{tabular}{|l|c|c|c|c|c|c|c|c|}
\hline
...
\begin{table}[htbp]\begin{minipage}{\textwidth}
\caption{MPA analýza \ce{SiCH3(PO4(CH3)2)(Si2P2O9(CH3)4)}, \textbf{M}, výsledky jsou uvedeny v [\%].}
\begin{center}
\begin{tabular}{|l|c|c|c|c|c|c|c|c|}
\hline
...
\begin{table}[htbp]\begin{minipage}{\textwidth}
\caption{MPA analýza \ce{Si(Si2P2O9(CH3)4)2}, \textbf{N},výsledky jsou uvedeny v [\%].}
\begin{center}
\begin{tabular}{|l|c|c|c|c|c|c|c|c|}
\hline
