...
\caption{ \ce{SiCH3(OCH3)5} Výchozí rentgenové struktury;  Legedna: \mycircle{brown} Si, \mycircle{red} O, \mycircle{orange} C,  \mycircle{yellow} P, \mycircleempty{black}~H}
\label{rtg_6}
\end{center}
\end{figure}
...
\caption{\ce{Si(OCH3)4} Výchozí rentgenové struktury;  Legedna: \mycircle{brown} Si, \mycircle{red} O, \mycircle{orange} C, \mycircleempty{black}~H}
\label{rtg_4}
\end{center}
\end{figure}
...
\caption{ \ce{SiCH3(OCH3)5} Výchozí rentgenové struktury;  Legedna: \mycircle{brown} Si, \mycircle{red} O, \mycircle{orange} C, \mycircleempty{black}~H}
\label{rtg_5}
\end{center}
\end{figure}
